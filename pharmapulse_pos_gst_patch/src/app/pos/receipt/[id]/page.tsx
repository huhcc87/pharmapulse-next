    ...
    <div className="p-6">
      <div className="max-w-md mx-auto border p-4">
        ...
        <div className="mt-3 text-sm">
          <div><span className="text-slate-600">Invoice:</span> {inv.invoiceNumber}</div>
          ...
          <div><span className="text-slate-600">Type:</span> {inv.invoiceType}</div>
        </div>
        ...
        <div className="mt-4 text-xs text-slate-600">
          ...
          set up the Local Print Bridge described in AI_GST_IMPLEMENTATION_ROADMAP.md.
        </div>
      </div>
